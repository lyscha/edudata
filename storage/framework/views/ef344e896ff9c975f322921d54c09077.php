        ...
        <div class="d-flex align-items-center justify-content-center w-100">
          <div class="row justify-content-center w-100">
            <div class="col-md-8 col-lg-6 col-xxl-3">
              <div class="card mb-0">
                <div class="card-body">
                  <form method="POST" action="<?php echo e(route('loginProses')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Masukkan Password..">
...
</html><?php /**PATH C:\xamppe\htdocs\ProjectUasMapil\resources\views/auth/login.blade.php ENDPATH**/ ?>