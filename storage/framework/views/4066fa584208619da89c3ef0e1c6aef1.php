                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="javascript:void(0)" id="drop2"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?php echo e(Auth::user()->profile_picture ?? asset('/BS/assets/images/profile/avatar.jpeg')); ?>"
                                width="35" height="35"
...
<?php /**PATH C:\xamppe\htdocs\ProjectUasMapil\resources\views/layout/app.blade.php ENDPATH**/ ?>